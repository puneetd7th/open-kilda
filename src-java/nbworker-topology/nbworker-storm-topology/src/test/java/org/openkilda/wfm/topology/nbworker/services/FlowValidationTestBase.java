...
public class FlowValidationTestBase extends InMemoryGraphBasedTest {
    ...
    protected static void setUpOnce() {
        ...
        vxlanRepository = persistenceManager.getRepositoryFactory().getVxlanRepository();
    ...
    protected void buildFlow(FlowEncapsulationType flowEncapsulationType, String endpointSwitchManufacturer) {
        Switch switchA = switchRepository.add(Switch.builder().switchId(TEST_SWITCH_ID_A).description("").build());
        switchA.setOfDescriptionManufacturer(endpointSwitchManufacturer);
        Switch switchB = switchRepository.add(Switch.builder().switchId(TEST_SWITCH_ID_B).description("").build());
        Switch switchC = switchRepository.add(Switch.builder().switchId(TEST_SWITCH_ID_C).description("").build());
        Switch switchE = switchRepository.add(Switch.builder().switchId(TEST_SWITCH_ID_E).description("").build());
    ...
    protected void buildOneSwitchPortFlow() {
        Switch switchD = switchRepository.add(Switch.builder().switchId(TEST_SWITCH_ID_D).description("").build());
