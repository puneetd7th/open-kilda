...
public class Switch implements CompositeDataEntity<Switch.SwitchData> {
    ...
    public Switch(@NonNull Switch switchToClone) {
        this();
        SwitchCloner.INSTANCE.copy(switchToClone.getData(), getData());
    }
    ...
    public int hashCode() {
        return new HashCodeBuilder(17, 37)
                .append(getSwitchId())
                .append(getStatus())
                .append(getSocketAddress())
                .append(getHostname())
                .append(getController())
                .append(getDescription())
                .append(getOfVersion())
                .append(getOfDescriptionManufacturer())
                .append(getOfDescriptionHardware())
                .append(getOfDescriptionSoftware())
                .append(getOfDescriptionSerialNumber())
                .append(getOfDescriptionDatapath())
                .append(getFeatures())
