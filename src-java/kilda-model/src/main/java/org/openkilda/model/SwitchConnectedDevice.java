...
public class SwitchConnectedDevice implements CompositeDataEntity<SwitchConnectedDevice.SwitchConnectedDeviceData> {
    ...
    public SwitchConnectedDevice(@NonNull SwitchConnectedDevice entityToClone) {
        this();
        SwitchConnectedDeviceCloner.INSTANCE.copyWithoutSwitch(entityToClone.getData(), data);
    ...
    public int hashCode() {
        return new HashCodeBuilder(17, 37)
                ...
                .append(getPortId())
                .append(getTtl())
                .append(getPortDescription())
                .append(getSystemName())
                .append(getSystemDescription())
                .append(getSystemCapabilities())
                .append(getManagementAddress())
                .append(getTimeFirstSeen())
                .append(getTimeLastSeen())
                .toHashCode();
    }
