 ...
 */
@Slf4j
abstract class FermaGenericRepository<E extends CompositeDataEntity<D>, D> implements Repository<E> {
    ...
    public void remove(E entity) {
        ...
        if (data instanceof ElementFrame) {
            transactionManager.doInTransaction(((ElementFrame) data)::remove);
        } else {
