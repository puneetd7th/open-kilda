...
class FermaSwitchConnectedDevicesRepository
        extends FermaGenericRepository<SwitchConnectedDevice, SwitchConnectedDeviceData>
    ...
    public Collection<SwitchConnectedDevice> findAll() {
        return framedGraph().traverse(g -> g.V().hasLabel(SwitchConnectedDeviceFrame.FRAME_LABEL))
                .toListExplicit(SwitchConnectedDeviceFrame.class).stream()
                .map(SwitchConnectedDevice::new).collect(Collectors.toList());
    }
        ...
        Collection<? extends SwitchConnectedDeviceFrame> devices =
                framedGraph().traverse(g -> FermaSwitchRepository.getTraverseForSwitch(g, switchId)
                        ...
                        .has(SwitchConnectedDeviceFrame.TYPE_PROPERTY,
                                ConnectedDeviceTypeConverter.INSTANCE.map(ConnectedDeviceType.LLDP))
    ...
    public Optional<SwitchConnectedDevice> findArpByUniqueFieldCombination(
        ...
        Collection<? extends SwitchConnectedDeviceFrame> devices =
                framedGraph().traverse(g -> FermaSwitchRepository.getTraverseForSwitch(g, switchId)
                        ...
                        .has(SwitchConnectedDeviceFrame.MAC_ADDRESS_PROPERTY, macAddress)
                        .has(SwitchConnectedDeviceFrame.TYPE_PROPERTY,
                                ConnectedDeviceTypeConverter.INSTANCE.map(ConnectedDeviceType.ARP))
    ...
    @Override
    public SwitchConnectedDevice add(SwitchConnectedDevice entity) {
        SwitchConnectedDeviceData data = entity.getData();
        ...
        return transactionManager.doInTransaction(() ->
                new SwitchConnectedDevice(SwitchConnectedDeviceFrame.create(framedGraph(), data)));
    }
}
