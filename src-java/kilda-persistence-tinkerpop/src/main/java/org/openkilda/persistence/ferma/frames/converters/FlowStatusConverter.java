 ...
 */
@Mapper
public interface FlowStatusConverter {
    FlowStatusConverter INSTANCE = Mappers.getMapper(FlowStatusConverter.class);

    default String map(FlowStatus value) {
        if (value == null) {
            return null;
        }
    ...
    default FlowStatus map(String value) {
