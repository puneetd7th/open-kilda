...
public class FermaFlowPathRepositoryTest extends InMemoryGraphBasedTest {
    ...
    public void setUp() {
        ...
        flow = flowRepository.add(Flow.builder()
                .flowId(TEST_FLOW_ID)
                .srcSwitch(switchA)
                .srcPort(1)
                .destSwitch(switchB)
    ...
    public void shouldFindByEndpointSwitch() {
        ...
        Collection<FlowPath> paths = flowPathRepository.findByEndpointSwitch(switchA.getSwitchId(), false);
    ...
    public void shouldFindBySrcSwitch() {
        ...
        Collection<FlowPath> paths = flowPathRepository.findBySrcSwitch(switchA.getSwitchId(), false);
    ...
    public void shouldFindPathBySrc() {
        ...
        Collection<FlowPath> foundPaths = flowPathRepository.findBySrcSwitch(switchA.getSwitchId(), false);
        assertThat(foundPaths, hasSize(1));
    }
    ...
    public void shouldNotFindPathByWrongSrc() {
        ...
        Collection<FlowPath> foundPaths = flowPathRepository.findBySrcSwitch(switchB.getSwitchId(), false);
    ...
    public void shouldFindPathByEndpointSwitch() {
        ...
        Collection<FlowPath> foundPaths = flowPathRepository.findByEndpointSwitch(switchB.getSwitchId(), false);
        assertThat(foundPaths, hasSize(1));
    }
    ...
    public void shouldFindInactivePathBySegmentSwitch() {
        Flow activeFlow = Flow.builder()
                ...
                .status(FlowStatus.UP)
                .build();
        activeFlow = flowRepository.add(activeFlow);
    ...
    private FlowPath createFlowPath(
        ...
        FlowPath flowPath = flowPathRepository.add(FlowPath.builder()
    ...
    private FlowPath createTestFlowPathWithIntermediate(Switch intSwitch, int intPort) {
        ...
        flowPath = flowPathRepository.add(flowPath);
        flow.addPaths(flowPath);
        return flowPath;
    }
}
