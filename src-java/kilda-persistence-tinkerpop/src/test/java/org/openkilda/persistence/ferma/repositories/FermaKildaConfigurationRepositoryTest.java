...
public class FermaKildaConfigurationRepositoryTest extends InMemoryGraphBasedTest {
    ...
    public void shouldCreateAndUpdateKildaConfiguration() {
        ...
        foundKildaConfiguration.setFlowEncapsulationType(FlowEncapsulationType.VXLAN);
        foundKildaConfiguration.setUseMultiTable(false);
        foundKildaConfiguration.setPathComputationStrategy(PathComputationStrategy.LATENCY);

        KildaConfiguration updatedKildaConfiguration = kildaConfigurationRepository.getOrDefault();
        assertEquals(foundKildaConfiguration, updatedKildaConfiguration);
