...
public class FermaSwitchConnectedDevicesRepositoryTest extends InMemoryGraphBasedTest {
    ...
    public void setUp() {
        ...
        connectedDeviceRepository = repositoryFactory.getSwitchConnectedDeviceRepository();
    ...
    public void deleteConnectedDeviceTest() {
        lldpConnectedDeviceA = connectedDeviceRepository.add(lldpConnectedDeviceA);
        lldpConnectedDeviceB = connectedDeviceRepository.add(lldpConnectedDeviceB);
    ...
    public void uniqueIndexTest() {
        ...
        createdDevice.setSwitchObj(secondSwitch);
    ...
    private SwitchConnectedDevice validateIndexAndUpdate(SwitchConnectedDevice device) {
        ...
        connectedDeviceRepository.add(device);
