...
public class HistoryService {
    ...
    public HistoryService(TransactionManager transactionManager, RepositoryFactory repositoryFactory) {
        ...
        flowHistoryRepository = repositoryFactory.getFlowHistoryRepository();
        flowDumpRepository = repositoryFactory.getFlowDumpRepository();
        portHistoryRepository = repositoryFactory.getPortHistoryRepository();
    }
    ...
    public void store(FlowHistoryHolder historyHolder) {
        transactionManager.doInTransaction(() -> {
            ...
            if (historyHolder.getFlowEventData() != null) {
                ...
                event = flowEventRepository.add(event);
            } else {
    ...
    public List<FlowEvent> listFlowEvents(String flowId, Instant timeFrom, Instant timeTo) {
        return flowEventRepository.findByFlowIdAndTimeFrame(flowId, timeFrom, timeTo);
    }
